...
public class Reservation {
	...
	public Reservation(int res_id, int num_nights, Time ch_i_time, Date ch_i_date, Time ch_o_time, Date ch_o_date,
	...
	public String toString() {
		return "Reservation [res_id=" + res_id + ", num_nights=" + num_nights + ", ch_i_time=" + ch_i_time
				+ ", ch_i_date=" + ch_i_date + ", ch_o_time=" + ch_o_time + ", ch_o_date=" + ch_o_date + ", g_id="
				+ g_id + ", r_id=" + r_id + ", status=" + status + "]";
	}
